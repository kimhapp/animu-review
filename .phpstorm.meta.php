...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\WriothesleyLover\Coding-Stuffs\WCT\Anime Project\animu-review\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\WriothesleyLover\\Coding-Stuffs\\WCT\\Anime Project\\animu-review\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'web','api',);
        registerArgumentsSet('routes', 'welcome','home.index','home.show','admin.dashboard',
'admin.anime','admin.anime.store','admin.anime.edit','admin.anime.update','admin.anime.destroy',
'admin.category','admin.category.store','admin.category.edit','admin.category.update','admin.category.destroy',
'admin.genre','admin.genre.store','admin.genre.edit','admin.genre.update','admin.genre.destroy',
'admin.privilege','admin.privilege.store','admin.privilege.edit','admin.privilege.update','admin.privilege.destroy',
'admin.country','admin.country.store','admin.country.edit','admin.country.update','admin.country.destroy',
'review.create','review.store','review.edit','review.update','review.destroy',
'google.redirect','google.callback','profile','profile.edit','profile.update',
'profile.delete','register','login',
...
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','VITE_FIREBASE_API_KEY','VITE_FIREBASE_AUTH_DOMAIN','VITE_FIREBASE_PROJECT_ID',
