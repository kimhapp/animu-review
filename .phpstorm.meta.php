...
'web','api',);
        registerArgumentsSet('routes', 'home','dashboard','google.login','google.callback','profile.edit','profile.update','profile.destroy','password.edit',
...
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT',);
